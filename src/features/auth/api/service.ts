...
export const authService = {
  ...
  forgotPassword: (body: ForgotPasswordRequest) => apiClient<ForgotPasswordResponse>("/auth/password/forgot", { method: "POST", body: JSON.stringify(body), auth: false }),
  resetPassword: (body: ResetPasswordRequest) => apiClient<MessageResponse>("/auth/password/reset", { method: "POST", body: JSON.stringify(body), auth: false }),
